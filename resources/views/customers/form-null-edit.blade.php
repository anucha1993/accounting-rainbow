...
<div class="tab-content">
    <div class="tab-pane active" id="home2" role="tabpanel">
        <h5>Passport Information Edit Default </h5>
        ...
        <div class="row">
            ...
            <div class="col-3 md-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="customer_tel" placeholder="Tel" value="{{$cus->customer_tel}}" >
                </div>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" name="addJob" value="addJob" class="btn btn-primary">Save and Add Job Order</button> &nbsp; &nbsp;
        &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
